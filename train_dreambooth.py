...
import json
import os
# for c in concepts_list:#创建张译文件夹.
#     os.makedirs(c["instance_data_dir"], exist_ok=True)

with open("concepts_list.json", "w") as f:#配置写入json文件.
...
#============重新加载全部模型用来训练.
    ...
    if not args.train_text_encoder:#文本部分我们一般不训练了.
...
if __name__ == "__main__":
    ...
    args.pretrained_vae_name_or_path="/sd-vae-ft-mse"
